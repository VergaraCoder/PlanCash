...
export const RegisterBuy = ({setForm,form,sendForm,styleContainerGeneral,styleForm,styleInput,styleInputDate,styleButtonCancel,styleButtonSend,setError}:PropsRegisterBuy) => {
